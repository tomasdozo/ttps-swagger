...
public interface MenuControllerInterface {
    ...
    @ApiResponse(responseCode = "200", description = "Menu Created", content = @Content(schema = @Schema(implementation = MenuDTO.class), mediaType = MediaType.APPLICATION_JSON_VALUE, examples = @ExampleObject(value = "{\"uuid\": \"ed69f005-cb85-4e7b-aea7-b075b59fae09\",\"plate\": \"Hamburguesa\",\"dessert\": \"Helado\",\"beverage\": \"Coca\"}")))
    ...
    @ApiResponse(responseCode = "200", description = "Menu Updated", content = @Content(schema = @Schema(implementation = MenuDTO.class), mediaType = MediaType.APPLICATION_JSON_VALUE, examples = @ExampleObject(value = "{\"uuid\": \"ed69f005-cb85-4e7b-aea7-b075b59fae09\",\"plate\": \"Hamburguesa\",\"dessert\": \"Helado\",\"beverage\": \"Pepsi\"}")))
